...
namespace Qtool
{
    ...
    public class FrameItemRecipe
    {
        ...
        void drawRecipeColumn(RecipeProto recipeProto, int row, int col)
        {
            ...
            drawRecipeItemOrResultBox(row, columnmini, recipeProto.Results.Length);
            ...
            GUI.Label(Plugin.实例.布局.newrectFrameRecipeText(row, col), recipeProto.ID.ToString());


            drawRecipeItemOrResultBox(row, col+2, recipeProto.Items.Length);
